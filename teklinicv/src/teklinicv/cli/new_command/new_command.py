...
@app.command(
    name="new",
    help=(
        "Generate a YAML input file to get started. Example: [yellow]teklinicv new"
        ' "John Doe"[/yellow]. Details: [cyan]teklinicv new --help[/cyan]'
    ),
)
@handle_user_errors
def cli_command_new(
    ...
    lines.append(f"  2. Run: [cyan]teklinicv render {input_file_path}[/cyan]")
