...
from .section import BaseTekliniCVSection, Section, get_teklinicv_sections
...
class Cv(BaseModelWithExtraKeys):
    ...
    def teklinicv_sections(self) -> list[BaseTekliniCVSection]:
        ...
        """
        return get_teklinicv_sections(self.sections)
    ...
    def validate_list_or_scalar_fields(
        ...
        if info.field_name is None:
            raise TekliniCVInternalError("field_name is None in validator")
