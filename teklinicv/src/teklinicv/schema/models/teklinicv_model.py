...
class TekliniCVModel(BaseModelWithoutExtraKeys):
    ...
    settings: Settings = pydantic.Field(
        ...
        title="TekliniCV Settings",
        description="The settings of the TekliniCV.",
    )

    _input_file_path: pathlib.Path | None = pydantic.PrivateAttr(default=None)

    @pydantic.model_validator(mode="after")
    def set_input_file_path(self, info: pydantic.ValidationInfo) -> "TekliniCVModel":
