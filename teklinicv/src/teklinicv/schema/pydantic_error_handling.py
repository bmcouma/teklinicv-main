...
from teklinicv.exception import TekliniCVInternalError, TekliniCVValidationError
...
def parse_plain_pydantic_error(
    ...
    return TekliniCVValidationError(
        location=location,
...
def parse_validation_errors(
    ...
    all_final_errors: list[TekliniCVValidationError] = []
...
def get_inner_yaml_object_from_its_key(
    ...
    try:
        ...
        try:
            ...
            raise TekliniCVInternalError(message) from e
