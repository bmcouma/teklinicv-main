...
from .teklinicv_model_builder import read_yaml
...
def create_sample_teklinicv_pydantic_model(
    *, name: str = "John Doe", theme: str = "classic", locale: str = "english"
    ...
    return TekliniCVModel(cv=cv, design=design, locale=locale)
...
def create_sample_yaml_input_file(
    *,
    ...
    if theme not in available_themes:
        ...
        raise TekliniCVUserError(message)
    ...
    comment_to_add = (
        ...
        f" $schema=https://raw.githubusercontent.com/teklinicv/teklinicv/refs/tags/v{__version__}/schema.json\n"
    )
