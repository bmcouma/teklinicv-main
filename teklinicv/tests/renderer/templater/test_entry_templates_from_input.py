...
from teklinicv.renderer.templater.entry_templates_from_input import (
...
from teklinicv.schema.models.locale.english_locale import EnglishLocale
...
class TestProcessDate:
    ...
    def test_raises_error_when_no_dates_exist(self):
        with pytest.raises(TekliniCVInternalError):
            process_date(
                date=None,
                start_date=None,
                end_date=None,
