...
from teklinicv.renderer.path_resolver import resolve_teklinicv_file_path
...
class TestResolveTeklinicvFilePath:
    ...
    def test_resolve_teklinicv_file_path(
        self,
