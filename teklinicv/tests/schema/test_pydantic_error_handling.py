...
from teklinicv.schema.models.validation_context import ValidationContext
from teklinicv.schema.pydantic_error_handling import (
...
class TestGetInnerYamlObjectFromItsKey:
    ...
    def test_raises_error_for_out_of_range_index(self):
        ...
        with pytest.raises(TekliniCVInternalError, match="Index 10 is out of range"):
    ...
    def test_raises_error_for_missing_key(self):
        ...
        with pytest.raises(TekliniCVInternalError, match="Key 'nonexistent' not found"):
