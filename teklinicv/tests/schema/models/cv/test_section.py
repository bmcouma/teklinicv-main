...
from teklinicv.schema.models.cv.entries.bullet import BulletEntry  # NOQA: F401
from teklinicv.schema.models.cv.entries.education import EducationEntry  # NOQA: F401
from teklinicv.schema.models.cv.entries.experience import ExperienceEntry  # NOQA: F401
from teklinicv.schema.models.cv.entries.normal import NormalEntry  # NOQA: F401
from teklinicv.schema.models.cv.entries.one_line import OneLineEntry  # NOQA: F401
from teklinicv.schema.models.cv.entries.publication import PublicationEntry  # NOQA: F401
from teklinicv.schema.models.cv.section import (
    Section,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("welcome_to_teklinicv!", "Welcome to Rendercv!"),
        ("Welcome to TekliniCV!", "Welcome to TekliniCV!"),
