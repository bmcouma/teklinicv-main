...
The `cv` field begins with your personal information. All fields are optional. TekliniCV adapts to whatever you provide.
...
TekliniCV provides << entry_count >> entry types:
