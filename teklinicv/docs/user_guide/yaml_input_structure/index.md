...
TekliniCV uses a single YAML file to generate your CV. This file has four top-level fields:
...
settings:
  ...
  # TekliniCV behavior (current date, bold keywords)
  ...
```
...
To maximize your productivity while editing the input YAML file, set up TekliniCV's JSON Schema in your IDE. It will validate your inputs on the fly and give auto-complete suggestions.
...
=== "Other Editors"
    ...
    1. Add this line at the top of your file:
        ```yaml
        # yaml-language-server: $schema=https://github.com/teklinicv/teklinicv/blob/main/schema.json?raw=true
        ```
