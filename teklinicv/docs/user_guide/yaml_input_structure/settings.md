...
The `settings` field configures TekliniCV's behavior, including output paths, file generation, and text formatting.
...
settings:
  ...
  render_command:
    ...
    typst_path: teklinicv_output/NAME_IN_SNAKE_CASE_CV.typ # (3)!
    pdf_path: teklinicv_output/NAME_IN_SNAKE_CASE_CV.pdf
    markdown_path: teklinicv_output/NAME_IN_SNAKE_CASE_CV.md
    html_path: teklinicv_output/NAME_IN_SNAKE_CASE_CV.html
    png_path: teklinicv_output/NAME_IN_SNAKE_CASE_CV.png
