...
1. Create templates alongside your CV:
    ...
    ```bash
    teklinicv new "Your Name" --create-typst-templates
    ```
...
TekliniCV automatically uses your local templates instead of the built-in ones.
...
- Delete template files you don't need to customize (TekliniCV falls back to built-in versions)
