...
1. Create a YAML file in `src/teklinicv/schema/models/locale/other_locales/`

    ```bash
    touch src/teklinicv/schema/models/locale/other_locales/mylanguage.yaml
    ```
...
3. Add ISO 639-1 language code to `english_locale.py`
    ...
    Edit `src/teklinicv/schema/models/locale/english_locale.py` line 95-108:
...
4. Done. Use it:
    ...
    ```bash
    teklinicv new "John Doe" --locale mylanguage
    ```
