...
## TekliniCV's Workflows

TekliniCV has 5 workflows. Each handles a specific automation task.
...
### 1. [`test.yaml`](https://github.com/teklinicv/teklinicv/blob/main/.github/workflows/test.yaml): Run Tests
...
### 2. [`deploy-docs.yaml`](https://github.com/teklinicv/teklinicv/blob/main/.github/workflows/deploy-docs.yaml): Deploy Documentation
...
3. Documentation is now live at https://docs.teklinicv.com

### 3. [`update-files.yaml`](https://github.com/teklinicv/teklinicv/blob/main/.github/workflows/update-files.yaml): Update Generated Files
...
### 4. [`create-executables.yaml`](https://github.com/teklinicv/teklinicv/blob/main/.github/workflows/create-executables.yaml): Create Executables
...
### 5. [`release.yaml`](https://github.com/teklinicv/teklinicv/blob/main/.github/workflows/release.yaml): Publish a Release
...
5. **Publish to PyPI:** Downloads and uploads package so users can `pip install teklinicv`
6. **Publish Docker image:** Builds and pushes Docker image to GitHub Container Registry

## Learn More

- See [`.github/workflows/`](https://github.com/teklinicv/teklinicv/tree/main/.github/workflows) for TekliniCV's workflow files
