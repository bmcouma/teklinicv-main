...
You need two tools to develop TekliniCV:
...
- **[`just`](https://github.com/casey/just)**: Command runner. Development commands are defined in the [`justfile`](https://github.com/teklinicv/teklinicv/blob/main/justfile), and you need `just` to run them.
...
That's it! You're now ready to start developing TekliniCV.
