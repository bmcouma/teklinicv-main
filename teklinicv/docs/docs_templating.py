...
"[Structure of the YAML Input File](https://docs.teklinicv.com/user_guide/structure_of_the_yaml_input_file/)"
...
from teklinicv.schema.models.cv.social_network import available_social_networks
...
from teklinicv.schema.models.design.font_family import available_font_families
from teklinicv.schema.models.locale.locale import available_locales
from teklinicv.schema.yaml_reader import read_yaml

repository_root = pathlib.Path(__file__).parent.parent
teklinicv_path = repository_root / "src" / "teklinicv"
